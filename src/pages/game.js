...
class Game extends Component {
  ...
  saveChoice1 = (image, strenght, energy) => {
    this.setState({ choice1: image, strenght, energy });
  }

  saveChoice2 = (image, strenght, energy) => {
    this.setState({ choice2: image, strenght, energy });
    //alert('tests');
